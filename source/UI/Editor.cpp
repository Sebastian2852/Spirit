...
namespace UI
{
	...
	void Editor::initialiseStyling()
	{
		...
		// Mainly just for colors
		if (Platform::Core::s_theme.dark_mode)
		{
				...
				style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 0.84f);
		...
		// Styles for both dark and light mode
